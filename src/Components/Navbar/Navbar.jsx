    ...
    <div className={`md:fixed md:w-full z-10 ${dark? "bg-[#060024]": "bg-white"} ${isScrolled && "md:shadow-md"}`}>
      ...
      >
        ...
        <div className="hidden md:flex items-center gap-6">
          {links}
          <a href="https://drive.google.com/uc?export=download&id=1ZRWpcwTHGvUfgS0yfki_cbbc0fyCoGzI" download={"Mojahidul Islam's Resume"}>
          <button
            id="button-rs"
      ...
      {open ? (
        <div className="md:hidden absolute right-0 flex justify-end items-end">
          <div className={`w-[150px] ${dark? "bg-[#060024] text-white": "bg-white"} rounded-xl shadow-xl py-4 px-4 border space-y-3`}>
            {links}
            <div>
            {dark ? (
              <button  onClick={() => setDark(false)}>
